...
This projects involves exploration of data on the world's oldest businesses like when they were built and which domains they are a part of.

- Identified the number of businesses
  
- Businesses founded before the year 1000
  
- Explored the categories
  
- Identified the oldest business by continent
  
- Performing inner join on everything for further exploration
  
- Filtered counts by Continent and Category
